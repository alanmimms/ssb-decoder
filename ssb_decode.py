...
# Title: SSB decoder from SDR I/Q WAV files
# Author: alan
...
class ssb_decode(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "SSB decoder from SDR I/Q WAV files", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("SSB decoder from SDR I/Q WAV files")
        ...
        self.settings = Qt.QSettings("GNU Radio", "ssb_decode")
        ...
        self._vol_range = qtgui.Range(0, 4, 0.1, 0.5, 200)
        ...
        self._tune_range = qtgui.Range(-500000, 500000, 100, 0, 200)
        ...
        self.audio_sink_0 = audio.sink(audio_rate, 'sysdefault:CARD=Device', True)
        ...
        self.connect((self.blocks_complex_to_float_1, 1), (self.blocks_sub_xx_0, 0))
        self.connect((self.blocks_complex_to_float_2, 1), (self.blocks_null_sink_0_0, 0))
        self.connect((self.blocks_complex_to_float_2, 0), (self.blocks_sub_xx_0, 1))
        ...
        self.connect((self.hilbert_fc_0, 0), (self.blocks_complex_to_float_1, 0))
        self.connect((self.hilbert_fc_0_0, 0), (self.blocks_complex_to_float_2, 0))
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.low_pass_filter_0.set_taps(firdes.low_pass(1, self.samp_rate, 3500, 200, window.WIN_HAMMING, 6.76))
...
def main(top_block_cls=ssb_decode, options=None):
